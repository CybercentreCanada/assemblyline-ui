...
@api_login(require_type=['safelist_manage', 'signature_importer'], allow_readonly=False, required_priv=["W"])
...
@api_login(audit=False, required_priv=['W'],
           allow_readonly=False, require_type=['safelist_manage', 'signature_importer'])
...
@api_login(allow_readonly=False, require_type=['safelist_manage'])
