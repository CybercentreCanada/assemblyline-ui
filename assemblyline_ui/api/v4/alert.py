...
@api_login(required_priv=['R'], require_type=['alert_view'])
...
@api_login(require_type=['alert_view'])
...
@api_login(required_priv=['W'], allow_readonly=False, require_type=['alert_manage'])
...
@api_login(audit=False, check_xsrf_token=False, require_type=['alert_manage'])
