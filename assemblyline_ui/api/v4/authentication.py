...
@api_login(audit=False, require_role=[ROLES.apikey_access], quota=False)
...
@api_login(audit=False, require_role=[ROLES.obo_access], quota=False)
...
@api_login(audit=False, check_xsrf_token=False, quota=False)
def logout(**_):
    """
...
@api_login(audit=False, quota=False)
