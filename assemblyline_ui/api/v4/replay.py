...
@api_login(required_priv=['R'], require_role=['replay_system'])
...
@api_login(required_priv=['W'], require_role=['replay_system'])
...
@api_login(audit=True, required_priv=['W'], require_role=['replay_trigger'])
...
@api_login(audit=True, required_priv=['W'], require_role=['replay_system'])
...
@api_login(audit=False, required_priv=['W'], require_role=['replay_system'])
