...
@api_login(audit=False, check_xsrf_token=False, allow_readonly=False, require_type=['submission_create'])
...
@api_login(audit=False, allow_readonly=False, require_type=['submission_create'])
