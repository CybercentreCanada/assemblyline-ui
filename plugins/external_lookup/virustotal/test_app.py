...
def test_detailed_malicious(test_client, mock_lookup_exists):
    ...
    data = mock_lookup_exists(additional_attrs=additional_attrs)
...
def test_detailed_enrich(test_client, mock_lookup_exists):
    ...
    rsp = test_client.get(f"/details/sha256/{'a' * 64}?noraw=true&enrich=true", follow_redirects=True)
    expected = {
        "api_error_message": "",
        "api_response": [
            {
                ...
                "description": (
                    "3 security vendors and 1 sandboxes flagged this as malicious. Threat label: "
                    "trojan.w97m/rtfobfustream. Threat categories: trojan. Family labels: w97m, pfkno."
                ),
                "confirmed": False,
                "malicious": True,
                "enrichment": [
                    {"group": "summary", "name": "av_malicious", "name_description": "",
                     "value": 3, "value_description": ""},
                    {"group": "summary", "name": "sandbox_malicious", "name_description": "",
                     "value": 1, "value_description": ""},
                    {"group": "summary", "name": "threat", "name_description": "",
                     "value": "trojan.w97m/rtfobfustream", "value_description": ""},
                    {"group": "summary", "name": "threat_family", "name_description": "",
                     "value": "w97m", "value_description": ""},
                    {"group": "summary", "name": "threat_family", "name_description": "",
                     "value": "pfkno", "value_description": ""},
                    {"group": "summary", "name": "threat_category", "name_description": "",
                     "value": "trojan", "value_description": ""},
                    {"group": "summary", "name": "reputation", "name_description": "",
                     "value": -83, "value_description": ""},
                    {"group": "alerts", "name": "sigma_alerts_medium", "name_description": "",
                     "value": 1, "value_description": ""},
                    {"group": "alerts", "name": "sigma_alerts_low", "name_description": "",
                     "value": 2, "value_description": ""},
                    {"group": "yara_hits", "name": "https://github.com/examples/yara-rules", "name_description": "",
                     "value": "Doc_with_VBA", "value_description": "Detects an embedded VBA project."},
                    {"group": "sigma_alerts", "name": "medium", "name_description": "",
                     "value": "Change PowerShell Policies [Example_author]", "value_description": ""},
                    {"group": "info", "name": "labels", "name_description": "",
                     "value": "docx", "value_description": ""},
                    {"group": "info", "name": "labels", "name_description": "",
                     "value": "cve-2019-0199", "value_description": ""},
                    {"group": "info", "name": "labels", "name_description": "",
                     "value": "cve-2023-36884", "value_description": ""},
                    {"group": "sandboxes", "name": "VMRay", "name_description": "",
                     "value": "malicious", "value_description": ""},
                ],
            }
        ],
        "api_status_code": 200,
