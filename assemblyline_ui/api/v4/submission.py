...
@api_login(required_priv=['W'], allow_readonly=False, require_type=['submission_delete'])
...
@api_login(required_priv=['R'], require_type=['submission_view'])
...
@api_login(audit=False, required_priv=['R'], require_type=['submission_view'])
...
@api_login(audit=False, check_xsrf_token=False, require_type=['submission_view'])
...
@api_login(audit=False, check_xsrf_token=False, require_type=['submission_manage'])
