...
@api_login(allow_readonly=False, require_type=['workflow_manage'])
...
@api_login(audit=False, allow_readonly=False, required_priv=['R'], require_type=['workflow_view'])
...
@api_login(audit=False, allow_readonly=False, require_type=['workflow_manage'])
