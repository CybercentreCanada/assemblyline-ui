...
@api_login(required_priv=['R'], require_role=['alert_view'])
...
@api_login(require_role=['alert_view'])
...
@api_login(required_priv=['W'], allow_readonly=False, require_role=['alert_manage'])
...
@api_login(audit=False, check_xsrf_token=False, require_role=['alert_manage'])
